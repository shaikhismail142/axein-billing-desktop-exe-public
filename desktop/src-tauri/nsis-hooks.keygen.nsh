...
!macro NSIS_HOOK_PREINSTALL
  ...
  nsExec::Exec '"$SYSDIR\\WindowsPowerShell\\v1.0\\powershell.exe" -NoProfile -ExecutionPolicy Bypass -Command "$ErrorActionPreference=''SilentlyContinue''; $base = Join-Path $env:LOCALAPPDATA ''AxEin License Keygen''; Remove-Item (Join-Path $base ''_up_'') -Recurse -Force -ErrorAction SilentlyContinue"'
!macroend
